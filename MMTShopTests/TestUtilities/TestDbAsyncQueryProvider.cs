...
namespace MMTShopTest.TestUtilities
{
    ...
    internal static class TestDbAsyncUtilities
    {
        internal static void SetUpMockSet<TEntity>(Mock<DbSet<TEntity>> mockSet, IQueryable<TEntity> data) where TEntity : class
        {
